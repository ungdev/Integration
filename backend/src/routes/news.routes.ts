...
//Admin routes
newsRouter.post("/admin/createnews",checkRole("Admin",[]), upload.single("file"),  newsController.createNews);
...
newsRouter.post("/admin/updatenews", checkRole("Admin", []), upload.single("file"), newsController.updateNews);
