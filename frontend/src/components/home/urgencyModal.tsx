...
function UrgencyModal() {
    ...
    const [form, setForm] = useState({ contact_CE: '', urgency_contact_name: '', urgency_contact_phone: '' });
    ...
    return (
        <Modal title="Formulaire VSS et Urgence" visible={isLogin} onCancel={() => setSearchParams({})} buttons={null}>
            <div className="flex flex-col gap-4">
                ...
                <Input
                    placeholder="Contact CE"
                    value={form.contact_CE}
                    onChange={(e) => setForm({ ...form, contact_CE: e.target.value })}
                />
                <Input
